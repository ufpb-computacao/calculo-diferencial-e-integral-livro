...
Caso 1:: Encontremos o conjunto solução de latexmath:[$ -(x+1)<\left|{x^2+2x+1}\right|$, e o denotemos por ${\rm C.\,\,S.}1$]
+
...
Caso 2:: Encontremos o conjunto solução de latexmath:[$ (x+1)<\left|{x^2+2x+1}\right|$, e o denotemos por ${\rm C.\,\,S.}2$]
+
...
Assim, o latexmath:[${\rm C.\,\,S.}$ será obtido intersectando ${\rm C.\,\,S.}1$ e ${\rm C.\,\,S.}2$], isto é,
[latexmath]
++++
\[
...
Caso 1::: Encontremos o conjunto solução de latexmath:[$0< \dfrac{2x^2+4x+3}{x+1}$, e o denotemos por ${\rm C.\,\,S.}1$]. 
+
Desde que latexmath:[$ 2x^2+4x+3= 0$] não tem raízes reais, então latexmath:[$0< \dfrac{2x^2+4x+3}{x+1}$ equivale a $x+1>0$]. Logo,   latexmath:[${\rm C.\,\,S.} 1=(-1,+\infty)$].

Caso 2::: Encontremos o conjunto solução de latexmath:[$\dfrac{x(2x+3)}{x+1}>0$, e o denotemos por ${\rm C.\,\,S.}2$].
+
Desde que, latexmath:[$\dfrac{x(2x+3)}{x+1}>0$ equivale a $x(2x+3)(x+1)>0$]. Segue-se que, latexmath:[$r_1=-\frac{3}{2}$], latexmath:[$ r_2= -1$] e latexmath:[$ r_3= 0$], então  latexmath:[${\rm C.\,\,S.} 2=\left(-\frac{3}{2},-1\right)\cup (0,+\infty)$].

Assim, o latexmath:[${\rm C.\,\,S.}$ será obtido intersectando ${\rm C.\,\,S.}1$, ${\rm C.\,\,S.}2$ e $x>-\frac{3}{4} $], isto é,
[latexmath]
++++
\[
...
Portanto, latexmath:[${\rm C.\,\,S.}=(0,+\infty)$]  
--
