...
\\\Updownarrow \\
x>-\frac{3}{4} \quad \mbox{ e}\quad  \left(0< 4x+3+\dfrac{x+3}{x+1} \quad \mbox{e} \quad 4x+3-\dfrac{x+3}{x+1}>0\right)
\\\Updownarrow \\
 x>-\frac{3}{4} \quad \mbox{ e}\quad  \left(0< \dfrac{(4x+3)(x+1)+ x+3}{x+1} \quad \mbox{e} \quad \dfrac{(4x+3)(x+1)-(x+3)}{x+1}>0\right)
\\\Updownarrow \\
 x>-\frac{3}{4} \quad \mbox{ e}\quad  \left(0< 2\left(\dfrac{2x^2+4x+3}{x+1}\right) \quad \mbox{e} \quad 2\left(\dfrac{x(2x+3)}{x+1}\right)>0\right)
\\\Updownarrow \\
 x>-\frac{3}{4} \quad \mbox{ e}\quad  \left(0< \dfrac{2x^2+4x+3}{x+1} \quad \mbox{e} \quad \dfrac{x(2x+3)}{x+1}>0\right)
\end{array}
\]
++++
...
+
Desde que latexmath:[$ 2x^2+4x+3= 0$] não tem raízes reais, então  latexmath:[$r_1=-1$. Assim, $C.\,\,S. 1=(-1,+\infty)$].
