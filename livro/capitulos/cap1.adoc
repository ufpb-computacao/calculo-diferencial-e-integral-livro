...
++++
\[
\dfrac{x^2-4}{(x-13)\sqrt[4]{x^2-9}\sqrt{x-1}\sqrt[6]{x+3}}\geq 0\quad \Leftrightarrow\quad  x^2-9> 0\quad\mbox{e}\quad x-1>0\quad\mbox{e}\quad x+3>0 \quad\mbox{e}\quad\dfrac{x^2-4}{x-13}\leq 0\]
Por outro lado, pelo item(iii) de {\bf Inequações Irracionais}, temos que
\[
\dfrac{x+5}{x-4}\geq 0\quad \Leftrightarrow \quad (x+5)(x-4) \geq 0\quad \mbox{e}\quad x-4\neq 0
\]
