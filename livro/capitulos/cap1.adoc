...
&(x-4)(x+1)<0\\\\
\Leftrightarrow &(x-4<0 \quad \mbox{e}\quad x+1>0)\quad \mbox{ou} \quad (x-4>0\quad \mbox{e}\quad x+1<0)\\\\
...
\[
\begin{array}{ccccccccc}
&x^2-2<3x+2\quad \Leftrightarrow \quad x^2-3x<4\\\\
\Leftrightarrow &x^2-3x+\dfrac{9}{4}<4+\dfrac{9}{4}\quad \Leftrightarrow \quad\left(x-\dfrac{3}{2}\right)^2<\dfrac{25}{4}\\\\
\Leftrightarrow &\left(x-\dfrac{3}{2}\right)^2-\left(\dfrac{5}{2}\right)^2<0\quad \Leftrightarrow \quad\left(x-\dfrac{3}{2}-\dfrac{5}{2}\right)\left(x-\dfrac{3}{2}+\dfrac{5}{2}\right)<0\\\\
\Leftrightarrow &
\left(x-\dfrac{8}{2}\right)\left(x+\dfrac{2}{2}\right)<0\quad \Leftrightarrow \quad\left(x-4\right)\left(x+1\right)<0.
\end{array}
\]
++++ 
+
