...
Teorema 1.5::
Sejam latexmath:[$a$], latexmath:[$b$] e latexmath:[$x \in \mathbb{R}$], então:
... latexmath:[$|a|^2=a^2$];
...
--
+
... Se latexmath:[$b>0$], então latexmath:[$|x|<b $] se, e somente se, latexmath:[$-b<x<b$];
... Se latexmath:[$b\geq 0$], então  latexmath:[$|x|\leq b$] se, e somente se, latexmath:[$ -b\leq x\leq b$];
... latexmath:[$|x|> b $]  se, e somente se, latexmath:[$x>b$] ou latexmath:[$x<-b$];
... latexmath:[$|x|\geq b$] se, e somente se, latexmath:[$ x\geq b$] ou latexmath:[$x\leq-b$];
...
====
.. latexmath:[$|3x-5|=4$].
Solução:: Pelo item(ii) do *Teorema 1.5*, para $a=3x-5$ e $b=4$, temos que
latexmath:[$|3x-5|=4  \quad \,\Leftrightarrow \quad \, 3x-5=4$] ou	 latexmath:[$3x-5=-4  \quad \,\Leftrightarrow \quad \, x=3$] ou latexmath:[$x=\dfrac{1}{3}$].+
 Portanto,  latexmath:[$\frac{1}{3}$] e latexmath:[$3$] são raízes de latexmath:[$|3x-5|=4$].

.. latexmath:[$||7-4x|-3|=9$].
Solução:: Pelo item(ii) do *Teorema 1.5*, para $a=|7-4x|-3$ e $b=9$, temos que
...
latexmath:[$|7-4x| =12$] ou latexmath:[$|7-4x|=-6$], porém  por definição do valor absoluto se segue que latexmath:[$|7-4x|\geq 0$], assim  e latexmath:[$|7-4x|=-6<0$], é uma igualdade impossível, isto é, latexmath:[$|7-4x|=-6$] não tem raízes. Então, só devemos analisar latexmath:[$|7-4x| =12$]. +
Novamente, pelo item(ii) do *Teorema 1.5*, para $a=|7-4x|$ e $b=12$, temos que, latexmath:[$|7-4x| =12$] latexmath:[$ \quad \,\Leftrightarrow \quad \,$]  latexmath:[$7-4x =12$]  ou latexmath:[$7-4x=-12$] latexmath:[$ \quad \,\Leftrightarrow \quad \,$]  latexmath:[$7-12=4x$]  ou latexmath:[$7+12=4x$] latexmath:[$ \quad \,\Leftrightarrow \quad \,$] latexmath:[$ \quad \,\Leftrightarrow \quad \,$]  latexmath:[$-5=4x$]  ou latexmath:[$19=4x$] latexmath:[$ \quad \,\Leftrightarrow \quad \,$] 
