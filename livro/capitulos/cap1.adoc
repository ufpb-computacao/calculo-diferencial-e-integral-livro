...
++++
\[
  x \in \Big( (-\infty, -1]\cup[2,+\infty)\Big)\cap\Big( (-\infty, 5] \Big)\cap\Big((-\infty,3) \Big) \quad \Leftrightarrow \quad x \in (-\infty, -1]\cup[2, 3).
\]
++++
+
...
++++
\[
  x \in \Big( (-\infty, 8]\Big)\cap\Big( \mathbb{R} \Big)\cap\Big( [8,+\infty) \Big) \quad \Leftrightarrow \quad x \in \{8\}.
\]
++++
...
\]
\[
\quad \Leftrightarrow \quad x\geq -5 \quad \mbox{e} \quad 0> 0  \quad \mbox{e} \quad x< -5 \quad \Leftrightarrow \quad  \emptyset.
\]
++++
+
