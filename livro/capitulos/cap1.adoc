...
+
Lembre que, pela nota acima, latexmath:[$x+2\neq0$ implica que o intervalos que tenham $r_1=-2$ devem ser abertos neste extremo. Portanto, $C.\,\,S.=(-\infty,-2)\cup [2-2\sqrt{3},2+2\sqrt{3}\]$].
====
...
\]
++++
onde latexmath:[$a_0,\,\,a_1,\dots,a_n, b_0,\,\,b_1,\dots,b_m, c_0,\,\,c_1,\dots,c_l$] são contantes, latexmath:[$a_n> 0$, $b_m>0$ e $c_l>0$], latexmath:[$n$, $m$ e $l \in \mathbb{N}$]. Então, as inequações irracionais, numa variável, são da forma:
