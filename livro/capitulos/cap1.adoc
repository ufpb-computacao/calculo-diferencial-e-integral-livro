...
+
--
* latexmath:[$(x-2)(x+1)\geq 0\quad \Leftrightarrow \quad  x \in (-\infty, -1\]\cup[2,+\infty)$];
* latexmath:[$5 \geq x\quad \Leftrightarrow \quad   x \in (-\infty, 5\]$];
* latexmath:[$9x<27\quad \Leftrightarrow \quad  x \in (-\infty,3) $];
--
+
Assim, latexmath:[$x$] pertence à interceção destes intervalos, isto é
+
[latexmath]
++++
\[
...
+
--
* latexmath:[$x\geq 8\quad \Leftrightarrow \quad  x \in (-\infty, 8\]$];
* latexmath:[$0\leq 0 \quad \Leftrightarrow \quad   x \in \mathbb{R}$];
* latexmath:[$x\leq 8\quad \Leftrightarrow \quad  x \in [8,+\infty) $];
--
+
Assim, latexmath:[$x$] pertence à interceção destes intervalos, isto é
+
...
+
--
* latexmath:[$x\geq -5\quad \Leftrightarrow \quad  x \in (-\infty, -5\]$];
* latexmath:[$0\leq 0 \quad \Leftrightarrow \quad   x \in \mathbb{R}$];
* latexmath:[$x<-5\quad \Leftrightarrow \quad  x \in (-5,+\infty) $];
--
+
Assim, latexmath:[$x$] pertence à interceção destes intervalos, isto é
+
