...
Assim, 
\[\begin{array}{ccl}
81-x^2> 0\quad\mbox{e}\quad\dfrac{x+5}{x-4}\geq 0
&\Leftrightarrow &   81-x^2> 0\quad\mbox{e}\quad (x+5)(x-4) \geq 0\quad \mbox{e}\quad x-4\neq 0\\\\
&\Leftrightarrow &  (x+9)(x-9)< 0\quad\mbox{e}\quad (x+5)(x-4) \geq 0\quad \mbox{e}\quad x-4\neq 0.
\end{array}\]
Logo,
\[\begin{array}{rcrcl}
...
Assim, $x$ pertence à interceção destes intervalos, isto é
\[
  x \in ( -9,9)\cap[-5,4 ]\cap\Big(  (-\infty,4)\cup(4,+\infty) \Big) =(-9, -5]\cup (4,9).
\]
Portanto, 
\[{\rm C.\,\,S.}=(-9, -5]\cup (4,9).
\]
