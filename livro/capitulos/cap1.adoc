...
.Fórmula de Bhaskara
====
A *fórmula de Bhaskara* nos ajudará a encontrar as raízes de uma equação de segundo grau. Assim, para a equação de segundo grau:
[latexmath]
++++++++++++++++++++++++++++++++++++++++++++
\[
 ax^2+bx+c=0.
...
... latexmath:[$ax+b>0 \quad \Leftrightarrow\quad  x>-\frac{b}{a}$ se, e somente se, ${\rm C.\,\,S.}=\left(-\frac{b}{a}, + \infty\right)$];

... latexmath:[$ax+b<0 \quad \Leftrightarrow \quad x<-\frac{b}{a} $ se, e somente se, $ {\rm C.\,\,S.}=\left(-\infty, -\frac{b}{a}\right)$];

... latexmath:[$ax+b\geq 0 \quad \Leftrightarrow\quad  x\geq-\frac{b}{a}$ se, e somente se, ${\rm C.\,\,S.}=\left[-\frac{b}{a}, + \infty\right)$];

... latexmath:[$ax+b\leq 0 \quad \Leftrightarrow \quad x\leq-\frac{b}{a}$ se, e somente se, $ {\rm C.\,\,S.}=\left(-\infty, -\frac{b}{a}\right\]$].
