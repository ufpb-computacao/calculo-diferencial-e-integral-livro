...
Por outro lado,
\[\begin{array}{cclclll}
\dfrac{x+5}{(x-4)(81-x^2)}\leq 0 &\Leftrightarrow & \dfrac{x+5}{(x-4)(9-x)(9+x)}\leq 0\\\\
& \Leftrightarrow & -\dfrac{x+5}{(x-4)(x-9)(x+9)}\leq 0\\\\
&\Leftrightarrow & \dfrac{x+5}{(x-4)(x-9)(x+9)}\geq 0
\end{array}\]
e pelo item iii de {\bf Inequações Irracionais} temos que 
\[
\begin{array}{cclc}
\dfrac{x+5}{(x-4)(x-9)(x+9)}\geq 0&
\Leftrightarrow & (x+5){(x-4)(x-9)(x+9)}\geq 0\quad \mbox{e}\quad (x-4)(x-9)(x+9)\neq 0.
\end{array}
\]
Assim,
\[
