...
+
Desde que latexmath:[$ 2x^2+4x+3= 0$] não tem raízes reais, então latexmath:[$0< \dfrac{2x^2+4x+3}{x+1}$ equivale a $$x+1>0$]. Logo,   latexmath:[$C.\,\,S. 1=(-1,+\infty)$].

Caso 2::: Encontremos o conjunto solução de latexmath:[$\dfrac{x(2x+3)}{x+1}>0$, e o denotemos por $C.\,\,S.2$].
+
Desde que, latexmath:[$\dfrac{x(2x+3)}{x+1}>0$ equivale a $x(2x+3)(x+1)>0$]. Segue-se que, latexmath:[$r_1=-\frac{3}{2}$], latexmath:[$ r_2= -1$] e latexmath:[$ r_3= 0$], então  latexmath:[$C.\,\,S. 2=\left(-\frac{3}{2},-1\right)\cup (0,+\infty)$].
