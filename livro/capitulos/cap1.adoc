...
.Fórmula de Bhaskara
====
A *fórmula de Bhaskara* a encontrar as raízes de uma equação de segundo grau, isto é, ajudará a resolver equações de segundo grau. Esta fórmula provavelmente está entre as cinco principais fórmulas matemáticas. Assim, para a equação de segundo grau:
[latexmath]
++++++++++++++++++++++++++++++++++++++++++++
\[
 ax^2+bx+c=0.
