...
+
--
... latexmath:[$\sqrt{P(x)}>Q(x)$] latexmath:[$ \quad \equiv \quad$] latexmath:[$\left( P(x)\geq 0\quad \mbox{e}\quad Q(x)\leq 0\right)\quad \mbox{ou}\quad \left(  P(x)\geq 0\quad \mbox{e}\quad P(x)>Q^2(x)\right)$]; 
