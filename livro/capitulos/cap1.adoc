...
\Leftrightarrow &\tiny{{(x^2-4)}(x-13)(x^2-9)(x-1)(x-4)\leq 0\quad \mbox{e}\quad(x-13)(x^2-9)(x-1)(x-4)\neq 0}\\\\\Leftrightarrow & \tiny{{(x-2)(x+2)}(x-13)(x-3)(x+3)(x-1)(x-4)\leq 0\quad \mbox{e}\quad(x-13)(x-3)(x+3)(x-1)(x-4)\neq 0.}
\end{array}
\]
