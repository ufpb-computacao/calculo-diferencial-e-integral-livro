...
+
--
latexmath:[$|3x-5|=4  \quad \,\Leftrightarrow \quad \, 3x-5=4\quad \mbox{ou}\quad 3x-5=-4  \quad \,\Leftrightarrow \quad \, x=3$ $\quad \mbox{ou}\quad $ $x=\dfrac{1}{3}$].
