...
++++
+
Fazendo latexmath:[$P(x)={(x+2)}{(x-1)x(x+1)}$ as raízes dos fatores são $r_1=-2$], latexmath:[$r_2=-1$], latexmath:[$r_3=0$] e 
...
+
Lembre que, pela nota acima, $ x+2\neq0$ implica que o intervalos que tenham $r_1=-2$ devem ser abertos neste extremo. Portanto, latexmath:[$C.\,\,S.=(-\infty,-2)\cup [2-2\sqrt{3},2+2\sqrt{3}\]$].
====
