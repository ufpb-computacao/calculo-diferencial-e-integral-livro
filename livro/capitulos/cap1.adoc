...
\[
C.\,\,S.=\left\{-\frac{5}{4},\frac{19}{4}\right\}.
\]
++++
--
...
+
--
Caso 1: ::: Se latexmath:[$x<-1$], então latexmath:[$ \quad x+1<0  \quad \, \Rightarrow  \quad \, |x+1|=-x-1$], latexmath:[$\quad x-2<-3  \quad \, \Rightarrow  \quad \, |x-2|=-x+2 \quad $] e latexmath:[$\quad x-4<-5  \quad \, \Rightarrow  \quad \, |x-4|=-x+4$]. Logo, latexmath:[$E(x)$] é equivalente a latexmath:[$-x+2-3x+12=-5x-5$]. Assim, latexmath:[$x=-19$] e latexmath:[$-19\in  (-\infty,-1)$], implicando que neste intervalo latexmath:[$-19$] é uma raíz de latexmath:[$|x-2|+3|x-4|=5|x+1|$].

Caso 2: ::: Se latexmath:[$-1\leq x<2$], então latexmath:[$ \quad 0\leq x+1<3  \quad \, \Rightarrow  \quad \, |x+1|=x+1$], latexmath:[$\quad -3\leq x-2<0  \quad \, \Rightarrow  \quad \, |x-2|=-x+2\quad $] e latexmath:[$\quad -5\leq x-4<-2  \quad \, \Rightarrow  \quad \, |x-4|=-x+4$]. Logo, latexmath:[$E(x)$] é equivalente a latexmath:[$-x+2-3x+12=5x+5$]. Assim, latexmath:[$x=1$] e latexmath:[$1 \in [-1,2)$], implicando que neste intervalo latexmath:[$1$] é uma raíz de latexmath:[$|x-2|+3|x-4|=5|x+1|$].
...
Caso 1:: Encontremos o conjunto solução de latexmath:[$ -(x+1)<\left|{x^2+2x+1}\right|$, e o denotemos por $C.\,\,S.1$]
+
...
Caso 2:: Encontremos o conjunto solução de latexmath:[$ (x+1)<\left|{x^2+2x+1}\right|$, e o denotemos por $C.\,\,S.1$]
+
...
Logo,
\[
C.\,\,S.2=(-\infty,-1)\cup (0,+\infty).
\]
++++

Assim, o latexmath:[$C.\,\,S.$ será obtido intersectando $C.\,\,S.1$ e $C.\,\,S.2$], isto é,
[latexmath]
++++
\[
...
Caso 1::: Encontremos o conjunto solução de latexmath:[$0< \dfrac{2x^2+4x+3}{x+1}$, e o denotemos por $C.\,\,S.1$]. 
+
Desde que latexmath:[$ 2x^2+4x+3= 0$] não tem raízes reais, então  latexmath:[$C.\,\,S. 1=(-1,+\infty)$].

Caso 2::: Encontremos o conjunto solução de latexmath:[$\dfrac{x(2x+3)}{x+1}>0$, e o denotemos por $C.\,\,S.2$].
+
Daqui, latexmath:[$r_1=-\frac{3}{2}$], latexmath:[$ r_2= -1$] e latexmath:[$ r_3= 0$], então  latexmath:[$C.\,\,S. 2=\left(-\frac{3}{2},-1\right)\cup (0,+\infty)$].
