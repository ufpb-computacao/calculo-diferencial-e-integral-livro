...
\[
\begin{array}{cccccc}
\dfrac{x-2}{x-4}>\dfrac{x+2}{x}\quad\Leftrightarrow \quad \dfrac{x+2}{x}-\dfrac{x-2}{x-4}<0\quad
\Leftrightarrow \quad \dfrac{(x+2)(x-4)-x(x-2)}{x(x-4)}<0\\\\
\Leftrightarrow \dfrac{-8}{x(x-4)}<0\quad \Leftrightarrow \quad\dfrac{1}{x(x-4)}>0.
\end{array} 
\]
