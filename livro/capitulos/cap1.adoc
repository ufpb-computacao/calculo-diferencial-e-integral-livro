...
\[
\begin{array}{cccccc} 
                &\dfrac{5x+2}{4}> \dfrac{x+1}{5}&\Leftrightarrow &\dfrac{5x+2}{4}- \dfrac{x+1}{5}>0&\Leftrightarrow &
\dfrac{5(5x+2)-4(x+1)}{20}\\\\
\Leftrightarrow &\dfrac{21x+6}{20}>0&\Leftrightarrow & \dfrac{3(7x+2)}{20}>0&\Leftrightarrow & {7x+2}>0\quad \Leftrightarrow \quad x>-\dfrac{2}{7}.
\end{array}\]
++++
+
Portanto,
