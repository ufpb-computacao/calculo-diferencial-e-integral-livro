...
\]
Fazendo $S(x)=(x+5)(x-4)(x-9)(x+9)$, temos que as raízes de $S(x)=0$ são $r_1=-9$, $r_2=-5$, $r_3=4$ e $r_4=9$. Pela nota acima $(x-4)(x-9)(x+9)\neq 0$ implica que os intervalos que tenham $r_1=-9$, $r_3=4$ e $r_4=9$ devem ser abertos nestes extremos. Desde que a inequação é da forma $S(x)\geq 0$,  podemos aplicar o item iii(a) do {\bf Caso I}, pois consideraremos todas as raízes.
...
... Se latexmath:[$n_i\geq 1$ e impar, para todo $i=1,\dots,k$], então temos as seguintes equivalências:
+
--
...
\Leftrightarrow &
x^2-9> 0\mbox{e}\quad x>4 \quad\mbox{e}\quad {(x^2-4)}{(x-13)} \leq 0\quad \mbox{e}\quad x\neq 13 0
