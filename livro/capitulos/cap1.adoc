...
++++
\[
Q_1(x)>0\quad \mbox{e} \quad Q_2(x)>0\quad \mbox{e} \quad\dots\quad \mbox{e} \quad Q_k(x)>0   \quad \mbox{e} \quad\dfrac{P(x)}{R(x)Q_{l+1}(x)Q_{l+2}(x)\dots Q_k(x)}\geq 0;
\]
++++
...
++++
\[
Q_1(x)>0\quad \mbox{e} \quad Q_2(x)>0\quad \mbox{e} \quad\dots\quad \mbox{e} \quad Q_k(x)>0  \quad \mbox{e} \quad\dfrac{P(x)}{R(x)Q_{l+1}(x)Q_{l+2}(x)\dots Q_k(x)}\leq 0.
\]
++++
--
--
