...
--
Método 1 (Fatorando):::
latexmath:[$4x^2-x-3=0$] latexmath:[$\,\,\,\Leftrightarrow\,\,\,$]  latexmath:[$(4x+3)(x-1)=0$] latexmath:[$\,\,\,\stackrel{\Leftrightarrow}{Teorema 1.1(x)}\,\,\,$]  latexmath:[$4x+3=0$] ou latexmath:[$x-1=0$] latexmath:[$\,\,\,\Leftrightarrow\,\,\,$]  
