...
++++
+
Logo, latexmath:[$E(x)$] é equivalente a latexmath:[$-x+2-3x+12=-5x-5$]. Assim, latexmath:[$x=-19$] e latexmath:[$-19\in  (-\infty,-1)$], implicando que neste intervalo latexmath:[$-19$] é uma raíz de latexmath:[$|x-2|+3|x-4|=5|x+1|$].
