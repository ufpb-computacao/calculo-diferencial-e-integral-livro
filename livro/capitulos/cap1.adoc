...
Pelo item(ix) do {\bf Teorema 1.5} para $b=-(x+1)$ e $c={x^2+2x+1}$ temos que:
[latexmath]
++++
\[
...
Novamente, pelo item(ix) do {\bf Teorema 1.5} para $b=x+1$ e $c={x^2+2x+1}$ temos que:
[latexmath]
++++
\[
(x+1)<\left|{x^2+2x+1}\right|\quad \Leftrightarrow \quad x^2+2x+1>(x+1) \quad \mbox{ou }\quad x^2+2x+1<-(x+1)
...
++++
\[
\Big((-1,+\infty)\Big)\cap\left(\left(-\frac{3}{2},-1\right)\cup (0,+\infty)\left)\cap \Big(\left(-\frac{3}{4},+\infty\right)\Big)=(0,+\infty)
\]
++++
...
++++
\[
\mathbb{Z}=-\mathbb{N}\cup\{0\}\cup \mathbb{N},\quad \mathbb{Q}=\left\{\dfrac{a}{b}: a\in \mathbb{Z}\,\,\,\mbox{e}\,\,\, b\in \mathbb{Z},\,\,\,\mbox{com}\,\,\,b \neq 0\right\}.
\]
++++
+
