...
+
--
latexmath:[$x^2-2<3x+2$] latexmath:[$\,\,\,\Leftrightarrow\,\,\,$]  latexmath:[$x^2-3x-4<0$]. Como latexmath:[$\Delta=(-3)^2-4(1)(-4)=25>0$], então latexmath:[$x^2-3x-4=0$] tem duas raízes reais diferentes:
[latexmath]
+++++
\[
...
--
+
Portanto, em todos estes casos obtivemos que
+
[latexmath]
++++
\[C.\,\,S.= (-1,4).\]
...
Solução::
Para latexmath:[$4x^2-x-3\geq 0$] temos que latexmath:[$\Delta=(-1)^2-4(4)(-3)=49>0$], então latexmath:[$4x^2-x-3=0$] tem duas raízes reais diferentes:
+
[latexmath]
+++++
\[
...
+
image::images/{cap}/raízes_polinomio.eps[scaledwidth="80%"]
+
Logo, 
...
+
image::images/{cap}/raízes_polinomio1.eps[scaledwidth="50%"]
+
Portanto,  
+
[latexmath]
...
+
image::images/{cap}/raízes_polinomio2.eps[scaledwidth="70%"]
+
Portanto,    
+
[latexmath]
...
+
image::images/{cap}/raízes_polinomio4.eps[scaledwidth="50%"]
+
...
+
image::images/{cap}/raízes_polinomio3.eps[scaledwidth="80%"]
+
...
+
image::images/{cap}/raízes_polinomio5.eps[scaledwidth="60%"]
+
...
Assim, $x$ pertence à interceção destes intervalos, isto é
\[
 x \in \tiny{\Big( (-\infty,-3)\cup(3,+\infty)\Big)\cap\Big( 1,+\infty \Big)\cap\Big( 4,+\infty \Big)\cap\Big( (-\infty,-2]\cup[2,13]\Big)\cap\Big((-\infty,13)\cup(13,+\infty)\Big)}
\]
Como
\[
\tiny{\Big( (-\infty,-3)\cup(3,+\infty)\Big)\cap\Big( 1,+\infty \Big)\cap\Big( 4,+\infty \Big)\cap\Big( (-\infty,-2]\cup[2,13]\Big)\cap\Big((-\infty,13)\cup(13,+\infty)\Big) =(4,13).}
\]
Se segue que,
\[
x \in (4,13).
