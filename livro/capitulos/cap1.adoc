...
Solução:: Para latexmath:[$x^2-1<0$] temos que latexmath:[$\Delta=(0)^2-4(1)(1)=-16<0$]. Então, do *Caso III* item(ii), se segue que latexmath:[$x^2+1=0$] não tem raízes em latexmath:[$\mathbb{R}$]. Portanto, latexmath:[$C.\,\,S.= \emptyset$].
...
+++++
\[
r_1=\dfrac{-(-1)-\sqrt{\Delta}}{2(4)}=\dfrac{1-\sqrt{49}}{8}=\dfrac{1-7}{8}=-\frac{3}{4}\quad \mbox{e}\quad r_2=\dfrac{-(-1)+\sqrt{\Delta}}{2(4)}=\dfrac{1+\sqrt{49}}{8}=\dfrac{1+7}{8}=\frac{8}{8}=1.
\]
++++ 
Aplicando o  item(iii) do *Caso II*, pois latexmath:[$r_1<r_2$], temos que latexmath:[$C.\,\,S.= \big(-\infty,-\frac{3}{4}\big\]\cup \big[1,+\infty\big)$].
