...
Solução:: Pelo item(xii) do *Teorema 1.5* para latexmath:[$a={x+1}$ e $b={x^2+2x+1}$]
+
[latexmath]
++++
\[
...
\]
Pelo item(ix) do *Teorema 1.5* para $b=-(x+1)$ e $c={x^2+2x+1}$ temos que:
\[
...
E, novamente, pelo item(ix) do *Teorema 1.5* para $b=x+1$ e $c={x^2+2x+1}$ temos que:
\[
(x+1)<\left|{x^2+2x+1}\right|\quad \Leftrightarrow \quad x^2+2x+1>(x+1) \quad \mbox{ou }\quad x^2+2x+1<-(x+1)
\]
\[
 \Leftrightarrow \quad x^2+x>0 \quad \mbox{ou }\quad x^2+3x+2<0\quad \Leftrightarrow \quad x(x+1)>0 \quad \mbox{ou }\quad (x+2)(x+1)<0\quad \Leftrightarrow \quad x \in (-\infty,-1)\cup (0,+\infty)
\]
Ou seja,
\[
\left|{x+1}\right|<\left|{x^2+2x+1}\right|\quad \Leftrightarrow \quad \Big(x \in (-\infty,-2)\cup (-1,+\infty)\Big)\quad \mbox{e}\quad \Big( x \in (-\infty,-1)\cup (0,+\infty)\Big)\quad \Leftrightarrow \quad x \in (-\infty,-2)\cup (0,+\infty)
\]
++++
+
