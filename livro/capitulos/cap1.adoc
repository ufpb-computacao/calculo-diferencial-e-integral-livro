...
\Leftrightarrow &x^2-3x+\dfrac{9}{4}<4+\dfrac{9}{4}\\\\
\Leftrightarrow &\left(x-\dfrac{3}{2}\right)^2<\dfrac{25}{4}\\\\
\Leftrightarrow &\left(x-\dfrac{3}{2}\right)^2-\left(\dfrac{5}{2}\right)^2<0\\\\
