...
... latexmath:[$ax+b>0 \quad \equiv\quad  x>-\frac{b}{a} \quad \Rightarrow \quad  C.\,\,S.=\left(-\frac{b}{a}, + \infty\right)$];

... latexmath:[$ax+b<0 \quad \equiv \quad x<-\frac{b}{a} \quad \Rightarrow \quad  C.\,\,S.=\left(-\infty, -\frac{b}{a}\right)$];

... latexmath:[$ax+b\geq 0 \quad \equiv\quad  x\geq-\frac{b}{a} \quad \Rightarrow \quad  C.\,\,S.=\left[-\frac{b}{a}, + \infty\right)$];

... latexmath:[$ax+b\leq 0 \quad \equiv \quad x\leq-\frac{b}{a} \quad \Rightarrow \quad  C.\,\,S.=\left(-\infty, -\frac{b}{a}\right\]$].
...
+
--
latexmath:[$x^2-2<3x+2$] latexmath:[$\,\,\,\Leftrightarrow\,\,\,$]  latexmath:[$x^2-3x-4<0$]. Como latexmath:[$\Delta=(-3)^2-4(1)(-4)=25>0$], então latexmath:[$x^2-3x-4=0$] tem raizes reais

 Logo, temos que as raízes de  latexmath:[$x^2-3x-4=0$] são latexmath:[$x=\dfrac{-(-3)\pm\sqrt{\Delta}}{2(1)}=\dfrac{3\pm\sqrt{\Delta}}{2}$], . Assim, latexmath:[$r_1=\dfrac{3-\sqrt{25}}{2}=\dfrac{-2}{2}=-1$]  e latexmath:[$r_2=\dfrac{3+\sqrt{25}}{2}=\dfrac{8}{2}=4$]. Aplicando o  item ii do *Caso I*, pois latexmath:[$r_1<r_2$], temos que latexmath:[$C.\,\,S.= (-1,4)$].
