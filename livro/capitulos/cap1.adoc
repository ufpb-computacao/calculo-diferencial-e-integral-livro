...
.. O número real latexmath:[$4$] é uma solução da inequação de segundo grau acima, pois latexmath:[$(4)^2-4(4)-5=-5< 0$]. Assim, latexmath:[$4 \in C.\,\,S.$];
.. Porém, os números reais latexmath:[$-1$] e  latexmath:[$5$] não são soluções, pois latexmath:[$(-1)^2-4(-1)-5= 0\not < 0$] e latexmath:[$(5)^2-4(5)-5= 0\not < 0$]. Assim latexmath:[$-1,\,\,5 \notin C.\,\,S.$].
============================
