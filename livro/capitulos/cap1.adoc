...
.. latexmath:[$\dfrac{x^2-4}{(x-13)\sqrt[6\]{x^2-9}\sqrt[7\]{x-1}\sqrt[4\]{x-4}}\leq 0$]
...
++++
\[
\dfrac{x^2-4}{(x-13)\sqrt[6]{x^2-9}\sqrt[4]{x-4}\sqrt[7]{x-1}}\leq 0
\]
++++
+
temos que latexmath:[$n_1=6$, $n_2=4$ e $n_3=7$], ou podemos aplicar o item iii(b) do *Caso VI*, para latexmath:[$l=2$ e $k=3$ e  $P(x)=x^2-4$, $Q_1(x)=\sqrt[6\]{x^2-9}$, $Q_2(x)=\sqrt[4\]{x-4}$, $Q_3(x)=\sqrt[7\]{x-1} $ e $R(x)=x-13$]. Assim, temos que:
+
[latexmath]
++++
\[
\dfrac{x^2-4}{(x-13)\sqrt[6]{x^2-9}\sqrt[4]{x-4}\sqrt[7]{x-1}}\leq 0\quad \Leftrightarrow\quad  x^2-9> 0\quad\mbox{e}\quad x-4>0 \quad\mbox{e}\quad\dfrac{x^2-4}{(x-13)(x-1)}\leq 0\]
Por outro lado, pelo item(iv) de {\bf Inequações Irracionais}, temos que
\[
\dfrac{x^2-4}{(x-13)(x-1)}\leq 0\quad \Leftrightarrow \quad {(x^2-4)}{(x-13)(x-1)} \leq 0\quad \mbox{e}\quad (x-13)(x-1)\neq 0.
\]
Assim, 
\[
 x^2-9> 0\quad\mbox{e}\quad x-1>0\quad\mbox{e}\quad x-4>0 \quad\mbox{e}\quad\dfrac{x^2-4}{x-13}\leq 0\quad \Leftrightarrow\]
