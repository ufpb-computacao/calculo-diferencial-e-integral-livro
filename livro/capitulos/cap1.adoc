...
+
--
... latexmath:[$\sqrt{P(x)}>Q(x)$] latexmath:[$ \quad \equiv \quad$] latexmath:[$P(x)\geq 0$] e  latexmath:[$(Q(x)\leq 0\,\,\mbox{ou}\,\,  P(x)>Q^2(x))$]; 
... latexmath:[$\sqrt{P(x)}\geq Q(x)$]latexmath:[$ \quad \equiv \quad$]latexmath:[$P(x)\geq 0$] e  latexmath:[$(Q(x)\leq 0\,\,\mbox{ou}\,\,  P(x) \geq Q^2(x))$]; 

... latexmath:[$\sqrt{P(x)}<Q(x)$]latexmath:[$ \quad \equiv \quad$]latexmath:[$P(x)\geq 0$] e  latexmath:[$Q(x)> 0$] e latexmath:[$ P(x)<Q^2(x)$]; 
... latexmath:[$\sqrt{P(x)}\leq Q(x)$]latexmath:[$ \quad \equiv \quad$]latexmath:[$P(x)\geq 0$] e  latexmath:[$Q(x)\geq 0$] e latexmath:[$P(x) \leq Q^2(x)$].
--
...
+
--
... latexmath:[$\sqrt{P(x)}+ \sqrt{Q(x)}>0$]latexmath:[$ \quad \equiv \quad$]latexmath:[$(P(x)\geq 0\,\,\mbox{e}\,\,  Q(x)> 0)$]  ou latexmath:[$(P(x)> 0\,\,\mbox{e}\,\,  Q(x)\geq 0)$];
... latexmath:[$\sqrt{P(x)}+ \sqrt{Q(x)}\geq 0$]latexmath:[$ \quad \equiv \quad$]latexmath:[$P(x)\geq 0\,\,\mbox{e}\,\,  Q(x)\geq 0$];

... latexmath:[$\sqrt{P(x)}\pm \sqrt{Q(x)}\geq k$], latexmath:[$k > 0$]latexmath:[$ \quad \equiv \quad$]latexmath:[$P(x)\geq 0\,\,\mbox{e}\,\,  Q(x)\geq 0 \,\,\mbox{e}\,\, P(x)\geq (k\mp\sqrt{Q(x)})^2$];

... latexmath:[$\sqrt{P(x)}+ \sqrt{Q(x)}<0$]latexmath:[$ \quad \equiv \quad$]latexmath:[$C.S.=\emptyset$];
... latexmath:[$\sqrt{P(x)}+ \sqrt{Q(x)}\leq 0$]latexmath:[$ \quad \equiv \quad$]latexmath:[$P(x)= 0\,\,\mbox{e}\,\,  Q(x)= 0$].
--
...
+
--
... latexmath:[$\sqrt{P(x)}- \sqrt{Q(x)}>0$]latexmath:[$ \quad \equiv \quad$]latexmath:[$P(x)\geq 0\,\,\mbox{e}\,\,  Q(x)\geq  0$]  e latexmath:[$P(x)>  Q(x)$];
... latexmath:[$\sqrt{P(x)}- \sqrt{Q(x)}\geq 0$]latexmath:[$ \quad \equiv \quad$]latexmath:[$P(x)\geq 0\,\,\mbox{e}\,\,  Q(x)\geq 0$]   e latexmath:[$P(x)\geq   Q(x)$].
--
...
++++
\[
\dfrac{P(x)\sqrt[n]{Q(x)}}{R(x)}\geq 0 ,\quad\dfrac{P(x)\sqrt[n]{Q(x)}}{R(x)}\leq 0 ,\quad\dfrac{P(x)}{R(x)\sqrt[n]{Q(x)}}\geq 0 ,\quad\dfrac{P(x)}{R(x)\sqrt[n]{Q(x)}}\leq 0\quad \mbox{e}\quad \sqrt[n]{P(x)}\leq \sqrt[n]{Q(x)}.
\]
++++
+
com latexmath:[$n\geq 1$] e ímpar. Temos as seguintes equivalências:
+
--
...
++++
\[
{P(x)\sqrt[n]{Q(x)}}\geq 0 ,\quad{P(x)\sqrt[n]{Q(x)}}\leq 0 ,\quad\dfrac{P(x)}{R(x)\sqrt[n]{Q(x)}}\geq 0 ,\quad\dfrac{P(x)}{R(x)\sqrt[n]{Q(x)}}\leq 0\quad\sqrt[n]{P(x)}\geq Q(x)\quad \mbox{e}\quad \sqrt[n]{P(x)}\leq \sqrt[n]{Q(x)}.
\]
++++
+
...
...  latexmath:[$\sqrt[n\]{P(x)}\geq Q(x)$]latexmath:[$ \quad \,\equiv  \quad \,$]latexmath:[$P(x)\geq 0 \quad \mbox{e} \quad (Q(x)\leq 0 \quad \mbox{ou} \quad  P(x)\geq Q^n(x))$];
