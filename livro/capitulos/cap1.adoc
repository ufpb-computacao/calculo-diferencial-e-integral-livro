...
\]
temos que $n_1=6$, $n_2=4$ e $n_3=7$], ou podemos aplicar o item iii(b) do *Caso VI*, para latexmath:[$l=2$ e $k=3$ e  $P(x)=x^2-4$, $Q_1(x)=\sqrt[6\]{x^2-9}$, $Q_2(x)=\sqrt[4\]{x-4}$, $Q_3(x)=\sqrt[7\]{x-1} $ e $R(x)=x-13$]. Assim, temos que:
+
[latexmath]
++++
\[
